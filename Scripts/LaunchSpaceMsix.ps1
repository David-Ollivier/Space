...
$TaskAction = New-ScheduledTaskAction -Execute "PowerShell.exe" -Argument "-ExecutionPolicy Bypass C:\LaunchspaceMsix.ps1 -projectname $projectname -storage $storage - storagepass $storagepass -sharename $sharename -app1 $app1 -app2 $app2 -app3 $app3 -app4 $app4 -app5 $app5 -app6 $app6 -app7 $app7 -app8 $app8"
